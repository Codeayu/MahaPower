...
class GoogleGeminiService:
    ...
    def __init__(self):
        ...
        if not settings.GEMINI_API_KEY:
            raise ValueError("Google Gemini API key is missing. Please check your environment variables.")
    ...
    def generate_work_analysis(self, work_type: str, work_type_mr: str, district: str, district_mr: str, 
        ...
        try:
            ...
            # Create system instruction and user prompt
            full_prompt = f"""You are an expert business advisor for rural entrepreneurship in Maharashtra, India. Provide practical, location-specific business advice for village-level entrepreneurs.
